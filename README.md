...
### 1. 适用范围
```markdown
1. 在您使用本应用并使用网络服务时，本应用将可能收集的您的相关信息，包括但不限于您的IP地址、使用的语言、系统日期和时间、软硬件特征信息；
...
3. 任何本应用平台用户如从事上述活动，一经发现，本应用有权立即终止与该用户的服务协议。
...
4. 如您出现违反有关法律、法规或者本应用服务协议或相关规则的情况，需要向第三方披露；
...
### 5.本隐私政策的更改
```markdown
1. 如果决定更改隐私政策，我们会在本政策中、应用上架详情页所标识的网站中以及我们认为适当的位置发布这些更改，以便您了解我们如何收集、使用您的个人信息，哪些人可以访问这些信息，以及在什么情况下我们会透露这些信息。
2. 我们将保留随时修改本政策的权利，因此请经常查看。
3. 如对本政策作出重大更改，我们将会通过应用详情页说明通知的形式告知。
```
